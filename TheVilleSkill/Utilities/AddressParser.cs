...
namespace TheVilleSkill.Utilities
{
    public class AddressParser : IAddressParser
    {
        ...
        public async Task<bool> AreEqual(string firstAddress, string secondAddress)
        {
            ...
            return bestFirstAddressParsing.Address.Number == bestSecondAddressParsing.Address.Number
                && bestFirstAddressParsing.Address.HalfHouse == bestSecondAddressParsing.Address.HalfHouse
                && bestFirstAddressParsing.Address.Direction == bestSecondAddressParsing.Address.Direction
                && bestFirstAddressParsing.Address.Street == bestSecondAddressParsing.Address.Street
                && bestFirstAddressParsing.Address.Tag == bestSecondAddressParsing.Address.Tag
                && bestFirstAddressParsing.Address.Apartment == bestSecondAddressParsing.Address.Apartment;
        }
    }
}
